...
#SBATCH -o /s/ls4/users/romanrybka/YD/fsnn-classifiers/logs/ccn_f2_%j.out
#SBATCH -e /s/ls4/users/romanrybka/YD/fsnn-classifiers/logs/ccn_f2_%j.err
...
python $PWD/experiments/ccn/ccn_mnist_f2.py --epochs 1 --plasticity "stdp_nn_restr_synapse" --dataset "mnist" --n_estimators 51 --drop_extra True --n_mfcc 40

...
#SBATCH -o /s/ls4/users/romanrybka/YD/fsnn-classifiers/logs/ccn_hpo_mean_%j.out
#SBATCH -e /s/ls4/users/romanrybka/YD/fsnn-classifiers/logs/ccn_hpo_mean_%j.err
...
if [ $RESUME ]; then
  python $PWD/experiments/hpo/hpo_ccn_mean.py --dataset $D --plasticity $P --ho-bound 400 --drop-extra True --resume
else
  python $PWD/experiments/hpo/hpo_ccn_mean.py --dataset $D --plasticity $P --ho-bound 400 --drop-extra True
fi

...
if [ $RESUME ]; then
  python $PWD/experiments/hpo/ccn_mnist_hpo_2.py --plasticity $P --dataset $D --ho_bound 600 --resume
else
  python $PWD/experiments/hpo/ccn_mnist_hpo_2.py --plasticity $P --dataset $D --ho_bound 600
fi

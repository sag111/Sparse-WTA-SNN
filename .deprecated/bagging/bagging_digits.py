...
def main(args):
    ...
    path_to_configs = os.path.join(os.path.dirname(__file__), '../configs/digits/BaggingDiehlNetwork/')
...
if __name__ == "__main__":
    ...
    filename = os.path.join(out_path, f"sdn_digits_{pl_token}_{par_token}.json")

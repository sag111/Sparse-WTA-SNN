...
def main(args):
    ...
    for _ in range(5):
        ...
        path_to_configs = os.path.join(os.path.dirname(__file__), '../configs/fsdd/BaseDiehlNetwork/')
...
if __name__ == "__main__":
    ...
    filename = os.path.join(out_path, f"sdn_fsdd_base_{pl_token}_{par_token}.json")

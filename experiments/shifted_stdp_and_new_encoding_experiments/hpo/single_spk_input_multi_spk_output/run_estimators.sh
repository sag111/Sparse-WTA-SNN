...
#SBATCH -o /s/ls4/users/selibrin/spiking_researches/correlation_encoding_and_training/mnist/hpo/single_spk_input_multi_spk_output/logs/%A_%a.out
#SBATCH -e /s/ls4/users/selibrin/spiking_researches/correlation_encoding_and_training/mnist/hpo/single_spk_input_multi_spk_output/logs/%A_%a.err
...
(
    ...
    python /s/ls4/users/selibrin/spiking_researches/correlation_encoding_and_training/mnist/hpo/estimator.py \
      ...
      "$ensemble_number" \
      "$validation_size" \
      --script="/s/ls4/users/selibrin/spiking_researches/correlation_encoding_and_training/mnist/hpo/single_spk_input_multi_spk_output/neuron.py"
)

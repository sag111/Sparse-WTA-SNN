/*
 *  stdp_gaussian_with_sin_r_dependence_connection.h
 *
...
#ifndef STDP_GAUSSIAN_WITH_SIN_R_DEPENDENCE_CONNECTION_H
#define STDP_GAUSSIAN_WITH_SIN_R_DEPENDENCE_CONNECTION_H
...
class STDPGaussianWithSinRDependenceConnection : public Connection< targetidentifierT >
{
...
public:
   ...
   */
  STDPGaussianWithSinRDependenceConnection();
   ...
   */
  STDPGaussianWithSinRDependenceConnection( const STDPGaussianWithSinRDependenceConnection& ) = default;
  STDPGaussianWithSinRDependenceConnection& operator=( const STDPGaussianWithSinRDependenceConnection& ) = default;
...
private:
  ...
  double global_stdp_func( double w, double delta_t )
  {
    ...
    double a = parameter_func(w_norm, a1_, a2_, a3_, a4_);
    double b = parameter_func(w_norm, b1_, b2_, b3_, b4_);
    double c = parameter_func(w_norm, c1_, c2_, c3_, c4_);
    double d = parameter_func(w_norm, d1_, d2_, d3_, d4_);
    double f = parameter_func(w_norm, f1_, f2_, f3_, f4_);
...
template < typename targetidentifierT >
constexpr ConnectionModelProperties STDPGaussianWithSinRDependenceConnection< targetidentifierT >::properties;
...
template < typename targetidentifierT >
inline void
STDPGaussianWithSinRDependenceConnection< targetidentifierT >::send( Event& e, size_t t, const CommonSynapseProperties& )
{
...
template < typename targetidentifierT >
STDPGaussianWithSinRDependenceConnection< targetidentifierT >::STDPGaussianWithSinRDependenceConnection()
  : ConnectionBase()
  , weight_( 1.0 )
  , Wmax_( 1.0 / 0.1 ) // kOhm
  , Wmin_( 1.0 / 100 ) // kOhm
  ...
  , delta_t_max_( 5e+2 )
  , a1_( 8.00504012e+04 ), a2_( -5.26713157e+01 ), a3_( 5.94082430e+03 ), a4_( 6.33873125e+04 )
  , b1_( 19507.16679427 ), b2_( -47.17623242 ), b3_( 6268.13651055 ), b4_( -7074.06137392 )
  , c1_( -5.40563351e+03 ), c2_( 6.08104345e-02 ), c3_( -2.27273574e+02 ), c4_( 1.26507015e+03 )
  , d1_( 3.05949701e+03 ), d2_( 9.26270499e-01 ), d3_( -2.82127170e+02 ), d4_( 4.74305417e+02)
  , f1_(-0.07192382 ), f2_( 0.99202569 ), f3_( 2.61408509 ), f4_( -0.12393424)
{
}

template < typename targetidentifierT >
void
STDPGaussianWithSinRDependenceConnection< targetidentifierT >::get_status( DictionaryDatum& d ) const
{
...
template < typename targetidentifierT >
void
STDPGaussianWithSinRDependenceConnection< targetidentifierT >::set_status( const DictionaryDatum& d, ConnectorModel& cm )
{
...
#endif // of #ifndef STDP_GAUSSIAN_WITH_SIN_R_DEPENDENCE_CONNECTION_H
